...
class ResumableStorage:
    """
    Manages chunk and persistent storage for resumable uploads.
    """

    def __init__(self) -> None:
        # Use settings to determine storage backends
    ...
    def get_chunk_storage(self, *args: Any, **kwargs: Any) -> Storage:
        """
        Returns the chunk storage backend specified in settings as ADMIN_RESUMABLE_CHUNK_STORAGE.
    ...
    def get_persistent_storage(self, *args: Any, **kwargs: Any) -> Storage:
        """
        Returns the persistent storage backend specified in settings as ADMIN_RESUMABLE_STORAGE.
        Defaults to the default storage if not specified.
        """
